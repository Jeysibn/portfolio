...
- Preserve GitHub Pages deployment, Azure Functions API contracts, visitor counter, assistant history/error behavior, explicit light/dark theme behavior, active-section navigation, project and skill details, resume download and print/save, external contact links, accessibility behavior, and real release/health metadata.
